...
def main(page: ft.Page):
    ...
    # 1. Overview Section (UPDATED with larger profile picture)
    ...
    # 3. Individual Portfolio Reflection Section - ChecklistApp Focus
                ...
                ft.Container(
                    ...
                    content=ft.Row(
                        ...
                        controls=[
                            ...
                            ft.TextButton("Leadership Video", icon=ft.Icons.VIDEO_LIBRARY, url="https://example.com/leadership-demo", style=ft.ButtonStyle(color=ACCENT_TEAL)),
                        ],
                    ),
                ),
            ],
    ...
    blog_section = ft.Container(
        ...
        content=ft.Column(
            spacing=20,
            controls=[
                create_section_header("TECHNICAL BLOG: MINING ENGINEERING CONCEPTS", "Written technical explanations with embedded video insert placeholders."),
                ft.ResponsiveRow(
                    spacing=20,
                    run_spacing=20,
                    controls=[
                        ft.Container(
                            ...
                            content=ft.Column(
                                ...
                                controls=[
                                    ...
                                    ft.TextButton("Embedded Video Insert", icon=ft.Icons.PLAY_CIRCLE, url="https://example.com/mine-ventilation-video", style=ft.ButtonStyle(color=ACCENT_TEAL)),
                                ],
                            ),
                        ),
                        ft.Container(
                            ...
                            content=ft.Column(
                                ...
                                controls=[
                                    ...
                                    ft.TextButton("Embedded Video Insert", icon=ft.Icons.PLAY_CIRCLE, url="https://example.com/software-testing-video", style=ft.ButtonStyle(color=ACCENT_TEAL)),
                                ],
                            ),
                        ),
                    ],
